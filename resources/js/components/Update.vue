    ...
    export default {
        ...
        methods: {
            create: async function (event) {
                ...
                await sampah.updateSampah(this.id, {
                    name: this.name,
        ...
        created() {
            ...
            sampah.getSampahByID(this.$route.params.id)
            .then(response => {
                this.id = response.data.sampah.id;
                this.name = response.data.sampah.name;
                this.categoryId = response.data.sampah.category_id;
